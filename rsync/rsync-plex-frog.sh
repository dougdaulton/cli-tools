...
REMOTEPATH=(
	...
	[2]=/VOLUMES/KODIAK4TB1/PLEX_MUSIC
	[3]=/VOLUMES/KODIAK4TB1/PLEX_AUDIO
)

LOCALPATH=(
	[0]=/VOLUMES/FROG4TB/PLEX/MOVIES
	[1]=/VOLUMES/FROG4TB/PLEX/TV_SHOWS
	[2]=/VOLUMES/FROG4TB/PLEX/MUSIC
	[3]=/VOLUMES/FROG4TB/PLEX/AUDIO
)
