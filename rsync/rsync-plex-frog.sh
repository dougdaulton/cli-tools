...
REMOTEPATH=(
	'/VOLUMES/KODIAK4TB1/PLEX_MOVIES'
	'/VOLUMES/KODIAK4TB1/PLEX_TV'
	'/VOLUMES/KODIAK4TB1/PLEX_MUSIC'
	'/VOLUMES/KODIAK4TB1/PLEX_AUDIO'
)

LOCALPATH=(
	'/VOLUMES/FROG4TB/PLEX/MOVIES'
	'/VOLUMES/FROG4TB/PLEX/TV_SHOWS'
	'/VOLUMES/FROG4TB/PLEX/MUSIC'
	'/VOLUMES/FROG4TB/PLEX/AUDIO'
)
